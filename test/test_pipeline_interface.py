...
def _install_stubs():
    ...
    entity_code_quality_mod = types.ModuleType("entity.code_quality")
    ...
    sys.modules["entity.code_quality"] = entity_code_quality_mod
    sys.modules["langchain_openai"] = langchain_openai_mod


_install_stubs()
import pipeline_interface
...
class TestPipelineInterface(unittest.TestCase):
    ...
    @patch("pipeline_interface.call_selector")
    ...
    @patch("pipeline_interface.call_info_miner", return_value={"algorithm_doc": "doc"})
    ...
    @patch("pipeline_interface.call_code_generator_for_single_tool", return_value={"code_quality": "cq"})
    ...
    @patch("pipeline_interface.call_reviewer_for_single_tool", return_value={"code_quality": "reviewed"})
    ...
    @patch("pipeline_interface.call_evaluator_for_single_tool", return_value={"code_quality": "evaluated"})
    ...
    @patch("pipeline_interface.call_optimizer_for_single_tool", return_value={"code_quality": "optimized"})
    ...
    def test_call_reviewer_increments_review_count_on_error(self):
        class DummyReviewer:
            def test_code(self, code, tool, package_name, n_features=None):
                return "error"
    ...
    @patch("pipeline_interface.run_optimizer")
    @patch("pipeline_interface.run_evaluator")
