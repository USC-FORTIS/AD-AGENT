...
def _install_main_stubs():
    ...
    pipeline_interface_mod = types.ModuleType("api.pipeline")
    ...
    api_pkg.pipeline = pipeline_interface_mod
    ...
    entity_code_quality = types.ModuleType("models.code_quality")
    ...
    sys.modules["api.pipeline"] = pipeline_interface_mod
    sys.modules.setdefault("agents", agents_pkg)
    sys.modules["models"] = entity_pkg
    sys.modules["models.code_quality"] = entity_code_quality
